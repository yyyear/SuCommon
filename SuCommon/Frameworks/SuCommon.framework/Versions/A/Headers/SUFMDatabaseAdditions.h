...
/** Category of additions for `<SUFMDatabase>` class.
...
@interface SUFMDatabase (SUFMDatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `SUFMResultSet` of schema; `nil` on error.
 
 @see [SQLite File Format](http://www.sqlite.org/fileformat.html)
 */

- (SUFMResultSet * _Nullable)getSchema;
...
- (SUFMResultSet * _Nullable)getTableSchema:(NSString*)tableName;
